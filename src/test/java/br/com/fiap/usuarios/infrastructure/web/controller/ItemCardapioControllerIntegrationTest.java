...
class ItemCardapioControllerIntegrationTest {
    ...
    void shouldExecuteItemCardapioCrudFlow() throws Exception {
        ...
        long restauranteId = createRestaurante("Restaurante Item " + uniqueSuffix(), donoId);
    ...
    void shouldReturnValidationErrorsForInvalidItemPayload() throws Exception {
        long donoId = findUsuarioIdByEmail("Admin", "admin@restaurante.com");
        long restauranteId = createRestaurante("Restaurante Validação " + uniqueSuffix(), donoId);
    ...
    void shouldReturnNotFoundWhenItemBelongsToDifferentRestaurante() throws Exception {
        long donoId = findUsuarioIdByEmail("Admin", "admin@restaurante.com");
        long restauranteA = createRestaurante("Restaurante A " + uniqueSuffix(), donoId);
        long restauranteB = createRestaurante("Restaurante B " + uniqueSuffix(), donoId);
    ...
    private long createRestaurante(String nome, long donoId) throws Exception {
